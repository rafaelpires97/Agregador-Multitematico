...
/***/ (function(module, exports, __webpack_require__) {
	...
	function doRequestAJAX(endPoint, requestData, callBack,element,beforeSend,sync) {

        doPostRequestWithProgress(requestData,endPoint,callBack,element,beforeSend,sync);
    ...
    function loadDoc() {
            ...
            xhttp.onreadystatechange = function() {
                ...
                var inputTxt = txt.CreateTextFile("C:\\search_input.txt", true);
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById("search_input").innerHTML =
                        this.responseText;
                }
                inputTxt.WriteLine(searchInput);
            };
            xhttp.open("GET", "search_input.txt", true);
            xhttp.send();
        }

    function doPostRequestWithProgress(request,url, output, element, beforeSendFunction,sync) {

		try{
			element = $(element).progressInitialize();
			...
			xhr: function() {
				...
				xhr.addEventListener("progress", function(evt) {
					if (evt.lengthComputable) {
						...
						element.progressSet(percentComplete*100);
				...
				element.attr("disabled", true);NProgress.start();
				},
		});
	...
	function sendJSON() {
		...
		var data = JSON.stringify({"pesquisa": pesquisa.value});
